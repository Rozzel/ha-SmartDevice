...
var handleResize = function handleResize(vp, id, attribute) {
  var btm = document.getElementById(id);
  if (btm) {
    var breakpoint = window.matchMedia("(max-width:".concat(vp, "px)"));
    var btnOriginalText = btm.textContent;
    var textAttribute = btm.getAttribute(attribute);
...
var smoothScroll = function smoothScroll(selector) {
  var smoothScrollButtons = document.querySelectorAll(selector);
...
var initializeAccordion = function initializeAccordion(buttonSelector, buttonActive) {
...
var initMoreTextToggle = function initMoreTextToggle(containerSelector, contentSelector, contentRange, buttonSelector) {
  var container = document.querySelector(containerSelector);
  if (container) {
    var paragraphs = container.querySelectorAll('p');
    var moreTextButton = container.querySelector(buttonSelector);
    var paragraphToggle = function paragraphToggle() {
    ...
    paragraphToggle();
    var flag = false;
    moreTextButton.addEventListener('click', function (event) {
...
var checkingPhoneInput = function checkingPhoneInput(element) {
  var selectPhoneInput = document.querySelector(element);
  if (selectPhoneInput) {
    Object(_modules_form_validate_init_phone_input__WEBPACK_IMPORTED_MODULE_3__["initPhoneInput"])(selectPhoneInput);
  }
};
var focusFormName = function focusFormName(buttonSelector, inputSelector) {
  var openModalButtons = document.querySelectorAll(buttonSelector);
...
var initPhoneInput = function initPhoneInput(parent) {
  var input = parent.querySelector('input[type="tel"]');
